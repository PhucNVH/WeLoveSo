...
<div class="content-overlay">
    ...
    <a href="{{route('auth.signin')}}" class="join">Tham gia</a>
...
<!--                <p></p>-->
                ...
                <video  width="820" height="560" controls >
                    <source src="{{ asset('videos/welcome.mp4?autoplay=0') }} " type="video/mp4">
                    <source src="{{ asset('videos/welcome.mp4?autoplay=0') }} " type="video/ogg">
